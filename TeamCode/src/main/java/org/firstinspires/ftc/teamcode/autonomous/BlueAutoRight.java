...
//                hardwareMap.get(DigitalChannel.class, "Lift"), telemetry);
        ...
        drivetrain.moveToPositionMod(terminal, 5, 5, 0, 0.2, 3000);
        sleep(250);
        drivetrain.moveToPositionMod(origin, 5, 5, 0, 0.3, 3000);
        sleep(250);
        drivetrain.moveToPositionMod(middleZone, 5, 5, 0, 0.3, 6000);
        sleep(250);
